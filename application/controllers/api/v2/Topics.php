...
class Topics extends REST_Controller  {
	...
	public function index_post()
	{
        ...
        $main_arr['paths']['api/v2/topics/']['POST']['summary']='Get list of all the topics';
        $main_arr['paths']['api/v2/topics/']['POST']['description']='All the active topics list';
        $main_arr['paths']['api/v2/topics/']['POST']['parameters']='';
        if(!empty($data))
        {
    ...
    public function bysubcategory_post()
	{
        ...
        $main_arr['info']['generate_time']=date('d-m-Y H:i:s');
        $main_arr['info']['method']='POST';
        $main_arr['paths']['api/v2/topics/bycategory/(:num)']['POST']['summary']='Get list of all the topics by subcategory';
        $main_arr['paths']['api/v2/topics/bycategory/(:num)']['POST']['description']='All the active topics list belongs to a partcular subcategory';
        $main_arr['paths']['api/v2/topics/bycategory/(:num)']['POST']['parameters']='sid';
        if(!empty($data))
        {
            $main_arr['info']['response']['status'] = '1';
    ...
    public function byid_post()
	{
        ...
        $main_arr['info']['generate_time']=date('d-m-Y H:i:s');
        $main_arr['info']['method']='POST';
        $main_arr['paths']['api/v2/topics/byid/(:num)']['POST']['summary']='Get topics by id';
        $main_arr['paths']['api/v2/topics/byid/(:num)']['POST']['description']='Details of topics belongs to a partcular id';
        $main_arr['paths']['api/v2/topics/byid/(:num)']['POST']['parameters']='tid';
        if(!empty($newdata))
        {
            $datadata = array();
            //echo $data[0]->id;
