                            ...
                            <table id="example5" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($notice_data as $article) {
                                        ...
                                        echo "<td>" . $article->not_title . "</td>";
                                        echo "<td>" . $article->not_msg . "</td>";
                                        echo "<td>" . branch_name($article->not_branch)->branch_name . "</td>";
                                        echo "<td>" . cell_name($article->not_cell)->cell_name . "</td>";
                                        echo "<td>" . date("j F, Y", strtotime($article->created_at)) . "</td>";                                      
                                        echo "<td>";
                                        if ($this->session->userdata('logged_in_info')->userrole == 1) {
                                            if ($article->not_status == 1) {
                                                ?>
                                                <a href='#' data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                    data-deletelink="<?php echo base_url() . 'notifications/disable/' . $article->id; ?>"
                                                ...
                                                ?>
                                                <a href='#' data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                    data-deletelink="<?php echo base_url() . 'notifications/enable/' . $article->id; ?>"
