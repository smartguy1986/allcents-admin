...
class Users extends REST_Controller
{
    ...
    public function index_post()
    {
        ...
        if (!empty($uid)) {
            ...
            $main_arr['paths']['api/v2/users/(:num)']['POST']['summary'] = 'Get details of a particular user';
            $main_arr['paths']['api/v2/users/(:num)']['POST']['description'] = 'All the data of a particular user will be fetched based on the given id';
            $main_arr['paths']['api/v2/users/(:num)']['POST']['parameters'] = '';
            if (!empty($data)) {
                $this->db->select("COUNT(id) as tot");
    ...
    public function createuser_post()
    {
        ...
        $usermail = preg_replace('/[^a-zA-Z0-9\s]/','', strtolower(trim($this->input->post('usermail', TRUE))));
        $userchurchtitle = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('userchurchtitle', TRUE));
        $usertitle = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('usertitle', TRUE));
        $userfname = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('userfname', TRUE));
        $userlname = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('userlname', TRUE));
        $userphone = $this->input->post('userphone');
        $userdob = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('userdob', TRUE));
        $usergender = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('usergender', TRUE));
        $useraddress = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('useraddress', TRUE));
        $usercountry = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('usercountry', TRUE));
        $userprovince = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('userprovince', TRUE));
        $userdistrict = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('userdistrict', TRUE));
        $userbranch = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('userbranch', TRUE));
        $usercell = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('usercell', TRUE));
        $userpassword = $this->input->post('userpassword');
        $treasurer = preg_replace('/[^a-zA-Z0-9\s@]/','',$this->input->post('treasurer'));
            ...
            if (empty($udata)) {
                ...
                if (!empty($insertId)) {
                    ...
                    if (!empty($data)) {
                        ...
                        storemylog("User registration by Treasurer", "api/v2/users/createuser", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($data));
                    } else {
                        $main_arr['info']['response']['status'] = 0;
                        $main_arr['info']['response']['data'] = '';
                        $main_arr['info']['response']['message'] = 'Registration unsuccessful. Please Try again.';
                        storemylog("User registration by Treasurer", "api/v2/users/createuser", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "Registration unsuccessful. Please Try again.");
                    }
                }
            } else {
    ...
    public function updateuser_post()
    {
        ...
        if (empty($uid) || empty($utoken)) {
            ...
            storemylog("User data update via app", "api/v2/users/updateuser", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'Please send valid User ID and token to verify details');
        } else {
            ...
            if ($check_user > 0) {
                ...
                if (!empty($updateID)) {
                    ...
                    storemylog("User data update via app", "api/v2/users/updateuser", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "Your profile has been updated successfully");
                } else {
                    $this->db->select("*,DATE_FORMAT(NOW(), '%Y') - DATE_FORMAT(userdob, '%Y') - (DATE_FORMAT(NOW(), '00-%m-%d') < DATE_FORMAT(userdob, '00-%m-%d')) AS age");
                    $data = $this->db->get_where("snr_users", ['usermail' => $udata[0]->usermail, 'id' => $uid])->result();
                    $main_arr['info']['response']['status'] = '1';
                    ...
                    storemylog("User data update via app", "api/v2/users/updateuser", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], json_encode($data));
                }
            } else {
                $main_arr['info']['response']['status'] = '0';
                $main_arr['info']['response']['data'] = '';
                ...
                storemylog("User data update via app", "api/v2/users/updateuser", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'Either user do not exist or Token has been changed');
            }
    ...
    public function editpassword_post()
    {
        ...
        if (empty($oldpassword) || empty($newpassword) || empty($confirmpassword)) {
            ...
            storemylog("User Password Edit", "api/v2/users/editpassword", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'Empty values not allowed, please check');
        } else {
            ...
            if ($check_user > 0) {
                ...
                if (MD5($oldpassword) === $udata[0]->userpassword) {
                    if ($newpassword === $confirmpassword) {
                        ...
                        if (!empty($updateID)) {
                            ...
                            storemylog("User Password Edit", "api/v2/users/editpassword", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($unewarray));
                        } else {
                            $main_arr['info']['response']['status'] = '0';
                            $main_arr['info']['response']['data'] = '';
                            $main_arr['info']['response']['message'] = 'System Error, Please try again!';

                            storemylog("User Password Edit", "api/v2/users/editpassword", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'System Error, Please try again!');
                        }
                    } else {
                        $main_arr['info']['response']['status'] = '0';
                        $main_arr['info']['response']['data'] = '';
                        ...
                        storemylog("User Password Edit", "api/v2/users/editpassword", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'New Password and Confirm Password not matching');
                    }
                } else {
                    $main_arr['info']['response']['status'] = '0';
                    $main_arr['info']['response']['data'] = '';
                    ...
                    storemylog("User Password Edit", "api/v2/users/editpassword", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'Incorrect Old Password');
                }
            } else {
                $main_arr['info']['response']['status'] = '0';
                $main_arr['info']['response']['data'] = '';
                ...
                storemylog("User Password Edit", "api/v2/users/editpassword", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'Either user do not exist or Token has been changed');
            }
        }
        $this->response($main_arr, REST_Controller::HTTP_OK);
    }
    ...
    public function getalluser_post()
    {
        ...
        if (count($usersinfo) > 0) {
            ...
            storemylog("Get All User for Treasurer", "api/v2/users/getallusers", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], "Executed Successfully");
        } else {
            $main_arr['info']['response']['status'] = '0';
            $main_arr['info']['response']['data'] = "";
            $main_arr['info']['response']['message'] = "No user found in your cell, please try again";

            storemylog("Get All User for Treasurer", "api/v2/users/getallusers", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "No user found, please try again");
        }
    ...
    public function getuser_post()
    {
        ...
        if (count($uddata) > 0) {
            ...
            storemylog("User Details", "api/v2/users/getuser", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($data));
        } else {
            $main_arr['info']['response']['status'] = '0';
            $main_arr['info']['response']['data'] = "No user found, please try again";
            $main_arr['info']['response']['message'] = "Error";

            storemylog("User Details", "api/v2/users/getuser", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "No user found, please try again");
        }
    ...
    public function lastdonation_post()
    {
        ...
        if (count($donation) > 0) {
            ...
            storemylog("User Last Donation Details", "api/v2/users/lastdonation", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($unewarray));
        } else {
            $main_arr['info']['response']['status'] = '0';
            $main_arr['info']['response']['data'] = "";
            $main_arr['info']['response']['message'] = "No donation found, please try again";

            storemylog("User Last Donation Details", "api/v2/users/lastdonation", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "No donation found, please try again");
        }
    ...
    public function getdonation_post()
    {
        ...
        if (count($donations) > 0) {
            ...
            storemylog("User Donation History", "api/v2/users/getdonation", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($newdonatearray));
        } else {
            $main_arr['info']['response']['status'] = '0';
            $main_arr['info']['response']['data'] = "";
            $main_arr['info']['response']['message'] = "No donation found, please try again";
            ...
            storemylog("User Donation History", "api/v2/users/getdonation", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "No donation found, please try again");
        }
    ...
    public function treasuretransactionhistory_post()
    {
        ...
        if (!empty($tdata)) {            
            ...
            storemylog("Treasurer Transaction History (Self)", "api/v2/users/treasuretransactionhistory", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($tarray));
            ...
            storemylog("Treasurer Transaction History (Self)", "api/v2/users/treasuretransactionhistory", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'No transaction records found.');
        }
    ...
    public function usertransactionhistory_post()
    {
        ...
        if (!empty($tdata)) {
            ...
            storemylog("User Transaction History (Self)", "api/v2/users/usertransactionhistory", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($data));
        } else {
            ...
            storemylog("User Transaction History (Self)", "api/v2/users/usertransactionhistory", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "No transaction records found.");
        }
    ...
    public function treasuretransactionhistory_member_post()
    {
        ...
        storemylog("Treasurer Transaction History (Member)", "api/v2/users/treasuretransactionhistory_member", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($tdata));
    ...
    public function treasurerdonation_post()
    {
        ...
        if (count($donatedata) > 0) {
            ...
            storemylog("Treasurer Donation History (Member)", "api/v2/users/treasurerdonation", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($newarray));
        } else {
            $main_arr['info']['response']['status'] = '0';
            $main_arr['info']['response']['data'] = "";
            $main_arr['info']['response']['message'] = "No Donation Record Found.";

            storemylog("Treasurer Donation History (Member)", "api/v2/users/treasurerdonation", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "No Donation Record Found.");
        }
    ...
    public function userlist_post()
    {
        ...
        if (count($userdata) > 0) {
            ...
            storemylog("User List Dropdown for Treasurer Cash payment entry", "api/v2/users/userlist", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($newarray));
        } else {
            $main_arr['info']['response']['status'] = '0';
            $main_arr['info']['response']['data'] = "";
            $main_arr['info']['response']['message'] = "No Donation Record Found.";

            storemylog("User List Dropdown for Treasurer Cash payment entry", "api/v2/users/userlist", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], "No User Found.");
        }
