                            ...
                            <table id="example5" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($topics as $article) {
                                        ...
                                        echo "<td><a href='" . base_url() . "events/edit/" . $article->id . "'>" . substr($article->title, 0, 25) . "...</a></td>";
                                        echo "<td>" . date("j F, Y", strtotime($article->start_date)) . " - " . date("j F, Y", strtotime($article->end_date)) . " </td>";
                                        echo "<td>" . $article->event_address . "</td>";
                                        echo "<td>" . get_cat_name($article->category)->cat_name . "";
                                        echo "<td>" . country_name($article->event_country)->country_name . ", " . province_name($article->event_province)->provincename . ", " . district_name($article->event_district)->district_name . "</td>";
                                        echo "</td>";
                                        echo "<td>" . branch_name($article->event_branch)->branch_name . " | " . cell_name($article->event_cell)->cell_name . "</td>";
                                        echo "</td>";
