...
class General extends REST_Controller
{
    ...
    public function dashboard_post()
    {
        ...
        if (empty($userdata)) {
            ...
            storemylog("Content Details of user\'s Dashboard page", "api/v2/general/dashboard", "POST", json_encode($_POST), "0", $_SERVER['REMOTE_ADDR'], 'Token Mismatch');
        } else {
            ...
            storemylog("Content Details of user\'s Dashboard page", "api/v2/general/dashboard", "POST", json_encode($_POST), "1", $_SERVER['REMOTE_ADDR'], json_encode($data));
        }
