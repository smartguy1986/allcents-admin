...
<html lang="en">
    ...
    <div class="wrapper">
		...
		<div class="page-wrapper">
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											...
											{
                                            	echo "<a href='".base_url()."user/profile/".$userdata->id."'><img class='rounded-circle p-1 bg-primary' src='".base_url()."uploads/user_profile/".$userdata->userimage."' width='110'></a>";
											}
											else
											{
												echo "<a href='".base_url()."user/profile/".$userdata->id."'><img class='rounded-circle p-1 bg-primary' alt='user avatar' src='".base_url()."uploads/company/".company_info('company_logo')->company_logo."' width='110'></a>";
											}
                                            ?>
			...
			<p class="mb-0">Copyright © <?php echo date("Y");?>. All right reserved by <a href="https://www.allcents.tech" target="_blank">Sentebale Health App.</a></p>M-Y', strtotime($userdata->userregistered)); ?></span>
											</li>
										</ul>
									</div>
								</div>
