            ...
            <div class="page-content">
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        // echo "</pre>";
                        ?>
                        <form class="row g-3" method="post" action="<?php echo base_url('policies/add'); ?>"
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control text-ar-user topictextarea" id="topictextarea"
                                    name="policy_description" data-error2="Please enter Policy Description"></textarea>
                                <label></label>
                            </div>
                            <div class="col-6">
                                <label for="inputAddress" class="form-label">Policy Icon</label>
                                <input type="file" class="form-control text-val-user" id="inputEmail" name="policy_logo"
                                    data-error="Please Select Policy Icon">
                                <label></label>
                            </div>
                            <div class="col-6">
                                <label for="inputAddress" class="form-label">Policy Files</label>
                                <input type="file" class="form-control text-val-user" id="inputEmail"
                                    name="policy_files[]" data-error="Please Select Policy Files" multiple>
                                <label></label>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-12">
                                <input type="submit" class="btn btn-primary px-5" value="Create Policy">
                            </div>
                        </form>
                    </div>
                </div>
