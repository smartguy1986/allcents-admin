                                        ...
                                        if ($this->session->userdata('logged_in_info')->userrole == 1) {
                                            ...
                                            if ($article->status == 1) {
                                                ...
                                                |&nbsp;<a href='#' data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                    data-deletelink="<?php echo base_url() . 'notices/disable/' . $article->id; ?>"
                                                    data-deletetext="Are you sure to disable this notice?"><i
                                                ...
                                                ?>
                                                |&nbsp;<a href='#' data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                    data-deletelink="<?php echo base_url() . 'notices/enable/' . $article->id; ?>"
                                                    data-deletetext="Are you sure to enable this notice?"><i
                                                        class='fadeIn animated bx bxs-lock'></i></a>
                                                <?php
